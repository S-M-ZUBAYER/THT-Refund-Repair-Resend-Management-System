...
//             {selectedLanguage === "zh-CN" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
//                         <h1>需要客户服务领导批准的请求</h1>
//                         <p className='py-4'>这些是当前所有的退款请求列表。在这里，您可以检查并更新退款请求信息。然后请批准他们的退款请求。</p>
...
//             {selectedLanguage === "en-US" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
...
//             {selectedLanguage === "fil-PH" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
//                         <h1>Mga Hiling na Kailangan ng Pag-apruba ng Customer Service Leader</h1>
//                         <p className='py-4'>Ito ay lahat ng listahan ng kahilingan sa pagbabalik sa sandaling ito. Dito maaari mong suriin at i-update ang impormasyon ng kahilingan sa pagbabalik. At pagkatapos ay pakisang-ayunan ang kanilang kahilingan sa pagbabalik.</p>
//                     </div>
//                 </>
//             }

//             {selectedLanguage === "ms-MY" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
//                         <h1>Permintaan Perlu Diluluskan Oleh Customer Service Leader</h1>
//                         <p className='py-4'>Ini adalah senarai semua permintaan pembayaran balik pada masa ini. Di sini anda boleh menyemak dan mengemas kini maklumat permintaan pembayaran balik. Dan kemudian sila disahkan permintaan pembayaran balik mereka.</p>
//                     </div>
//                 </>
//             }

//             {selectedLanguage === "th-TH" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
//                         <h1>คำขอที่ต้องได้รับการอนุมัติจาก Customer Service Leader</h1>
//                         <p className='py-4'>นี้คือรายการคำขอคืนเงินทั้งหมดในขณะนี้ ที่นี่คุณสามารถตรวจสอบและอัปเดตข้อมูลคำขอคืนเงิน และหลังจากนั้นโปรดอนุมัติคำขอคืนเงินของพวกเขา</p>
//                     </div>
//                 </>
//             }

//             {selectedLanguage === "vi-VN" && user?.role === "Customer Service Leader" &&
//                 <>
//                     {selectedLanguage === "zh-CN" &&
//                         <div className="mt-16 mb-5">
//                             <h1>客户服务领导需审核的请求</h1>
//                             <p className='py-4'>这是当前所有退款请求的列表。在这里，您可以检查和更新退款请求的信息。然后，请批准他们的退款请求。</p>
//                         </div>
//                     }

//                     {selectedLanguage === "en-US" &&
//                         <div className="mt-16 mb-5">
//                             <h1>Requests Need To Be Approved By Customer Service Leader</h1>
//                             <p className='py-4'>These are all the lists of refund requests at the moment. Here, you can check and update the information for refund requests. Then, please approve their refund requests.</p>
//                         </div>
//                     }

//                     {selectedLanguage === "fil-PH" &&
//                         <div className="mt-16 mb-5">
//                             <h1>Mga Kailangang Aprubahan ng Customer Service Leader</h1>
//                             <p className='py-4'>Ito ang lahat ng listahan ng kahilingan para sa refund sa kasalukuyan. Dito sa lugar na ito, maaari mong tingnan at i-update ang impormasyon para sa mga kahilingan ng refund. Pagkatapos, pakiusapang aprubahan ang kanilang kahilingan ng refund.</p>
//                         </div>
//                     }

//                     {selectedLanguage === "ms-MY" &&
//                         <div className="mt-16 mb-5">
//                             <h1>Permintaan Perlu Disahkan Oleh Pemimpin Khidmat Pelanggan</h1>
//                             <p className='py-4'>Ini adalah senarai semua permintaan pemulangan wang pada masa ini. Di sini anda boleh menyemak dan mengemaskini maklumat permintaan pemulangan wang. Kemudian, sila luluskan permintaan pemulangan wang mereka.</p>
//                         </div>
//                     }
...
//                     {selectedLanguage === "vi-VN" &&
//                         <div className="mt-16 mb-5">
//                             <h1>Yêu cầu Cần Phê duyệt bởi Người Quản lý Dịch vụ Khách hàng</h1>
//                             <p className='py-4'>Đây là tất cả các danh sách yêu cầu hoàn tiền hiện có. Ở đây, bạn có thể kiểm tra và cập nhật thông tin yêu cầu hoàn tiền. Sau đó, vui lòng phê duyệt yêu cầu hoàn tiền của họ.</p>
//                         </div>
//                     }

//                     {selectedLanguage === "id-ID" &&
//                         <div className="mt-16 mb-5">
//                             <h1>Permintaan Perlu Disetujui oleh Pemimpin Layanan Pelanggan</h1>
//                             <p className='py-4'>Ini adalah semua daftar permintaan pengembalian dana saat ini. Di sini Anda dapat memeriksa dan memperbarui informasi permintaan pengembalian dana. Kemudian, harap disetujui permintaan pengembalian dana mereka.</p>
//                         </div>
//                     }
...
//             {selectedLanguage === "id-ID" && user?.role === "Customer Service Leader" &&
//                 <>
//                     <div className="mt-16 mb-5">
//                         <h1>Permintaan Perlu Disetujui oleh Customer Service Leader</h1>
//                         <p className='py-4'>Ini adalah semua daftar permintaan pengembalian dana pada saat ini. Di sini Anda dapat memeriksa dan memperbarui informasi permintaan pengembalian dana. Dan kemudian, harap disetujui permintaan pengembalian dana mereka.</p>
//                     </div>
